...
function gamipress_youtube_activity_triggers( $triggers ) {
    ...
    $triggers[__( 'Youtube', 'gamipress-youtube-integration' )] = array(
        'gamipress_youtube_watch_video'                    => __( 'Watch any video', 'gamipress-youtube-integration' ),
        'gamipress_youtube_watch_specific_video'           => __( 'Watch a specific video', 'gamipress-youtube-integration' ),
    );
...
function gamipress_youtube_log_extra_data_fields( $fields, $log_id, $type ) {
    ...
    switch( $trigger ) {
        ...
        case 'gamipress_youtube_watch_specific_video':
            ...
            $fields[] = array(
                'name' 	            => __( 'Video', 'gamipress-youtube-integration' ),
                'desc' 	            => __( 'Video watched by the user.', 'gamipress-youtube-integration' ),
                'id'   	            => $prefix . 'video_id',
                'type' 	            => 'html',
