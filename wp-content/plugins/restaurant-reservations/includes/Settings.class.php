	...
	public function load_settings_panel() {
		...
		$sap->add_setting(
			...
			array(
				...
				'title'			=> __( 'Allow Modification and Cancellation', 'restaurant-reservations' ),
				'description'			=> __( 'Adds an option to your booking form that lets guests modify or cancel their reservations.', 'restaurant-reservations' )
			)
		);
