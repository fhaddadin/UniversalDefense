...
if ( $cross_sells ) : ?>
	...
	<div class="cross-sells">
		...
		<?php
		$heading = apply_filters( 'woocommerce_product_cross_sells_products_heading', __( 'You may be interested in&hellip;', 'wolverine' ) );

		if ( $heading ) :
			?>
            <h4 class="widget-title"><?php echo esc_html( $heading ); ?></h4>
		<?php endif; ?>
